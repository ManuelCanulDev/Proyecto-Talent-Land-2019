...
<!-- ESTO HACE REFERENCIA A EL TITULO DE DONDE TE ENCUENTRAS -->
      <section class="content-header">
        <h1>
          Dashboard
          <small>Ingreso de datos fermentación</small>
        </h1>
      </section>
<!-- ESTO HACE REFERENCIA A EL TITULO DE DONDE TE ENCUENTRAS -->
      ...
      <form style="width: 100%; text-align:center; margin-left: auto; margin-right: auto; font-size: 15px;" action="indama-fer.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputPassword1" style="width: 30%; margin-left: auto; margin-right: auto;" name="samples_frecuency">
            </div>
        ...
        if(isset($_POST['btn1'])){ 
          ...
          $type = $_POST['type'];
          $samples_frecuency = $_POST['samples_frecuency'];
          $comments = $_POST['comments'];

       
            $sql = "INSERT INTO fermentacion(equipment_id, process_value, plc, manual, unit_of_measure, type, samples_frecuency, comments) VALUES ('$equipment_id','$process_value','$plc','$manual','$unit_of_measure','$type','$samples_frecuency','$comments')";

...
<!-- ESTO HACE REFERENCIA A EL TITULO DE DONDE TE ENCUENTRAS -->
      ...
      <form style="width: 100%; text-align:center; margin-left: auto; margin-right: auto; font-size: 15px;" action="indama-hidro.php" method="post">
        ...
        if(isset($_POST['btn1'])){ 
          ...
          $comments = $_POST['comments'];
           ...
           $sql = "INSERT INTO hidrolisis (equipment_id,process_value,manual,plc,unit_of_measure,type,samples_frequency,comments) VALUES ('$equipment_id','$process_value','$manual', '$plc', '$unit_of_measure', '$type','$samples_frecuency', '$comments')";

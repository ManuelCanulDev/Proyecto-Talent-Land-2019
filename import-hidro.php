...
<!-- ESTO HACE REFERENCIA A EL TITULO DE DONDE TE ENCUENTRAS -->
    ...
    <section class="content">
        ...
        <div class="container">
            <form action="import-hidro.php" method="post" enctype="multipart/form-data">
      ...
      if(isset($_POST['enviar'])){
        ...
        for ($i=2; $i <= 78; $i++) { 
            ...
            echo "<td>".$comments."</td>";
             ...
             $sql = "INSERT INTO hidrolisis (equipment_id,process_value,manual,plc,unit_of_measure,type,samples_frequency,comments) VALUES ('$equipment_id','$process_value','$manual', '$plc', '$unit_of_measure', '$type','$samples_frequency', '$comments')";
